        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-sm font-bold text-green-600">{candidate.testScore}%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div 
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          {candidate.strengths.map((strength, index) => (
            <div key={index} className="flex items-start space-x-2 p-2 bg-green-50 rounded-lg border border-green-200/50">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          {candidate.redFlags.map((flag, index) => (
            <div key={index} className="flex items-start space-x-2 p-2 bg-red-50 rounded-lg border border-red-200/50">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 border border-blue-200/50">
        ...
        <p className="text-sm text-gray-700">{candidate.selectionReason}</p>
      </div>
    </div>
  );
}

    ...
    <div className="p-4">
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="flex items-center space-x-2 px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors cursor-pointer">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-3 border border-blue-200/50">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-gray-900 text-sm">resume_sarah_johnson.pdf</p>
              <p className="text-xs text-gray-600">2.4 MB • Uploaded 1 hour ago</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="space-y-3">
          {candidate.resume.workHistory.map((work, index) => (
            <div key={index} className="border-l-4 border-blue-500 pl-3 bg-gradient-to-r from-blue-50/50 to-purple-50/50 rounded-r-lg py-2">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-3">
          {candidate.resume.projects.map((project, index) => (
            <div key={index} className="bg-gradient-to-r from-gray-50 to-green-50 rounded-lg p-3 border border-gray-200/50">

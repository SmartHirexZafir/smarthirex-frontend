...
export function Select(
  ...
  return (
    <div className="relative">
      <select
        className={cn("select appearance-none", className)}
        aria-describedby={describedBy}
        {...props}
      >
        {children}
      </select>
      <svg className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2" width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
